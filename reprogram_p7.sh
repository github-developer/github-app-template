#!/usr/bin/env bash
APP_BIN="C:\hh\dialog_14683_scratch\projects\dk_apps\templates\freertos_retarget\Happy_P7_QSPI_Release\freertos_retarget.binh"
DIALOG_WORKSPACE="/c/hh/dialog_14683_scratch"
BL_BIN="C:\hh\dialog_14683_scratch\sdk\bsp\system\loaders\ble_suota_loader\DA14683-00-Release_QSPI\ble_suota_loader.bin"
...
pushd "${BL_UTILS_PATH}"
./program_qspi_jtag.bat --jlink_path "c:\Program Files (x86)\SEGGER\JLink_V612i" "${BL_BIN}"
popd
# Example command
...
./initial_flash.bat --jlink_path "c:\Program Files (x86)\SEGGER\JLink_V612i" "${APP_BIN}"
popd
